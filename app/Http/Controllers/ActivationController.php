...
class ActivationController extends Controller
{
    public function index()
    {
        return view('index', [
            'stores' => Store::all(),
            'winners' => ReceiptRegistration::with('prize')->with('store')->where('prize_id', '!=', 1)->get(),
            'prizes' => Prize::where('id', '>', 1)->get(),
        ]);
    }
    ...
    public function storeReceipt(Request $request): RedirectResponse
    {
        ...
        $messages = [
            ...
            'store_id.required' => 'Wybierz sklep w jakim dokonano zakupu.',
        ];
